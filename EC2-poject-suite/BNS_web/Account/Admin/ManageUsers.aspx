<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ManageUsers.aspx.cs" Inherits="BNS_web.Account.Admin.ManageUsers" %>
    ...
    <div class="container body-content">
        <div class="row">
            <div class="col-md-12 table-responsive table-hover">
                <br />
                <h3>Maintain users and roles</h3>
                <asp:GridView ID="UsersGridView" runat="server" DataKeyNames="CustomerID" AutoPostBack="True" OnRowDeleted="RowDeleted" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowSorting="True" CssClass="table table-bordered table-striped table-condensed"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Name" ReadOnly="true" HeaderText="Role" SortExpression="Name" />
                        <asp:BoundField DataField="Address" HeaderText="Address" SortExpression="Address" />
                    </Columns>
                </asp:GridView>
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT Customers.FirstName,Customers.CustomerID, Customers.LastName, Customers.Address, AspNetUsers.Email, AspNetRoles.Name FROM AspNetUsers INNER JOIN AspNetUserRoles ON AspNetUsers.Id = AspNetUserRoles.UserId INNER JOIN Customers ON Customers.CustomerID = AspNetUsers.Id INNER JOIN AspNetRoles ON AspNetUserRoles.RoleId = AspNetRoles.Id" UpdateCommand="UPDATE [Customers] SET [FirstName] = @FirstName, [LastName] = @LastName, [Address] = @Address WHERE [Customers].[CustomerID] = @CustomerID "
                    DeleteCommand="Delete from Accounts WHERE CustomerCustomerID= @CustomerID;Delete from Customers WHERE CustomerID= @CustomerID;Delete from AspNetUsers WHERE Id= @CustomerID;Delete from AspNetUserRoles WHERE UserId= @CustomerID" />
            </div>
        </div>
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="tbEmail" ValidationGroup="addValidation" CssClass="col-md-2 control-label" Text="Email" />
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="tbFname" CssClass="col-md-2 control-label" Text="First Name" />
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="tbLName" CssClass="col-md-2 control-label" Text="Last Name" />
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="tbAddress" CssClass="col-md-2 control-label" Text="Address" />
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="ddlrrole" CssClass="col-md-2 control-label" Text="Role" />
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <asp:Button runat="server" OnClick="CreateUser_Click" ValidationGroup="addValidation" Text="Add New User" CssClass="btn btn-success" />
                    </div>
                </div>
            </div>
        </div>
